...
import nextjs_logo from "./assets/tech_logo/nextjs-logo.jpg";
...
import football_bk_trf from "./assets/work_logo/football boking turf.png";
...
export const projects = [
  {
    ...
    description:
      "A modern football turf booking platform built with a Django REST Framework backend and a React frontend. Users can easily browse available turfs, check time slots, make bookings, and complete payments through a seamless and responsive interface. The system also includes booking management, user authentication, and real-time availability updates.",
    image: football_bk_trf,
    tags: [
